  ...
  return (
    <div className="pt-16 min-h-screen bg-gray-50">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <AnimatedSection>
          <h1 className="text-4xl font-bold text-gray-900 mb-12">Research Projects</h1>
        </AnimatedSection>

        <div className="space-y-8">
          {projects.map((project, index) => (
            <AnimatedCard key={index} delay={index * 0.15} className="bg-white rounded-lg shadow-lg p-8 hover:shadow-xl transition-shadow">
              <h2 className="text-2xl font-bold text-gray-900 mb-6">{project.title}</h2>
              
              <div className="mb-6">
                <h3 className="text-lg font-semibold text-gray-800 mb-3">Research Abstract</h3>
                <p className="text-gray-700 leading-relaxed text-justify">{project.abstract}</p>
              </div>

              {project.domains && project.domains.length > 0 && (
                <div>
                  <h3 className="text-lg font-semibold text-gray-800 mb-3">Research Domains:</h3>
